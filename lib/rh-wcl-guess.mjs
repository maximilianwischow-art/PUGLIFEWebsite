...
/** Admin-assignable roles: Peon means "attendance based" in the UI. */
export const RH_WCL_ASSIGNABLE_GUILD_ROLES = Object.freeze(["Peon", "Puglead", "Raidlead", "Heallead", "Dpslead", "Core"]);
