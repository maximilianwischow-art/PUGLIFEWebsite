...
/** @typedef {{ raidHelperName: string, wclCharacterNames: string[], wclSources?: string[], wclGuessConfidence?: number[], guildRole?: string, verifiedAt?: string | null, discordUserId?: string, discordUserIdSource?: string }} RhWclLinkRow */
