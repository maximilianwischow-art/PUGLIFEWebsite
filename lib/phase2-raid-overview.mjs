...
export const PHASE2_RAID_CATALOG = [
  {
    ...
    headerImageUrl: "/raid-images/event-header-ssc.png?v=20260518ssc-vashj",
...
/** Synthetic T5 card — SSC + TK full clears on the same evening (computed from WCL). */
export const PHASE2_T5_ONE_NIGHT_META = {
  id: "t5-one-night",
  name: "T5 (One Night)",
  shortName: "SSC + TK",
  size: 25,
  ...
  imageUrl: "/raid-images/ssc.png",
  headerImageUrl: "/raid-images/event-header-ssc.png?v=20260518ssc-vashj",
  headerImageUrlSecondary: "/raid-images/event-header-tk.png?v=20260518tk-3x1b",
  bossesTotal: 10,
};
